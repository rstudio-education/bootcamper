...
We will make use of two additional packages for formatting output shown throughout the report: 
the **DT** package for interactive display of tabular output and the **glue** package for formatting text output.
