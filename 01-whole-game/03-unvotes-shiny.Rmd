...
data wrangling and visualization, and the __shiny__ package for interactivity.
...
We can easily change which countries are being plotted by changing the inputs 
below.
...
selectInput(
  ...
  choices = countries,
  selected = c("UK & NI", "US", "Turkey"),
  multiple = TRUE
)

unvotes_subset <- reactive({
  unvotes %>%
