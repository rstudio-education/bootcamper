...
include_graphics("img/untidy-data/hyperwar-airplanes-on-hand.png")
```
...
include_graphics("img/untidy-data/hiv-est-prevalence-15-49.png")
```
...
include_graphics("img/untidy-data/us-general-economic-characteristic-acs-2017.png")
```
...
.discussion[
What type of variable is `year` encoded as in this data frame? What do you think 
it should be?
]
...
combined + 
  plot_layout(nrow = 2) +
  plot_annotation(
    title = "Data types matter!",
    subtitle = "Year as numeric (top) and categorical (bottom)"
    )
```
