---
title: "Wrangle data <br> `r emo::ji('cowboy_hat_face')`"
output:
...
.pull-left[
```{r}
select(.data = hotels, hotel, lead_time)
```
]
--
.pull-right[
...
.your-turn[
- Go to RStudio Cloud and start the second assignment: `03 - Wrangle Data`
- Open the first R Markdown file: `hotels.Rmd`
...
- Go to RStudio Cloud and start the second assignment: `03 - Wrangle Data`
- Open the first R Markdown file: `hotels.Rmd`
- Knit the document, and work on Exercises 5 and 6.
]
...
- Go to RStudio Cloud and start the second assignment: `03 - Wrangle Data`
- Open the first R Markdown file: `hotels.Rmd`
- Knit the document and work on the Exercises 7 and 8.
]
