...
.midi[
.your-turn[
- Start the assignment titled 06 - Data types and open `01-type-coercion.Rmd`.
...
**Strong recommendation:** One person should share their screen to facilitate discussion.
]
]
...
## to conlcude our discussion on data frames / tibbles...
...
.your-turn[
- Start the assignment titled 06 - Data types and open `02-forcats.Rmd`.
- Recreate the following -- first, the x-axis, and then, as a stretch goal, the y-axis.
]

```{r fig.height=3, fig.width=9, echo=FALSE, message=FALSE}
library(scales)
...
### Step 3b. Visualise number of bookings per date, using a smooth curve.
