...
- Replace the `x` and/or `y` aesthetics with other variables from the dataset, run the chunk, and observe what you get. You might get a reasonable plot, or an error. If you get an error, try another variable.
- Discuss why certain variables make sense to represent with points and others don't.
...
starwars <- starwars %>%
  mutate(
    hair_color2 = fct_other(hair_color,
