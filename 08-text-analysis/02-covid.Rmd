...
We will make use of two additional packages for formatting output shown throughout the report: the **DT** package for interactive display of tabular output and the **glue** package for formatting text output.
...
The following are step by step instructions for getting the data formatted for the eventual visualisation we will make.

1. Filter the data for "deaths". Confirm that there are 
